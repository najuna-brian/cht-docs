...
| update_sent_forms                                                           | **Deprecated in 3.7.x** Update sent*forms property on facilities so we can setup reminders for specific forms. \_As of 3.7.x, reminders no longer require this transition*                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
